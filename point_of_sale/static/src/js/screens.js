...
var ProductCategoriesWidget = PosBaseWidget.extend({
    ...
    init: function(parent, options){
        var self = this;
        this._super(parent,options);
        // console.log('this._super(parent,options)',this._super(parent,options));
...
var ProductListWidget = PosBaseWidget.extend({
    ...
    init: function(parent, options) {
        ...
        // console.log( ' options.product_list',options.product_list);
...
var ProductScreenWidget = ScreenWidget.extend({
    ...
    start: function(){ 
        // console.log('ProductScreenWidget.start()');
        var self = this;
